...
Un componente importante que se debe añadir a una página web es la accesibilidad.

Dicho por el director de la W3C, Tim Berners-Lee:

***El poder de la web está en su universalidad.***
***El acceso de todas las personas independientemente de la discapacidad es un aspecto esencial.***

Hoy en día es importante que nuestras aplicaciones y páginas sean accesibles, la web es un derecho para todas las personas incluidas las personas que tienen discapacidades físicas, motoras, visuales o auditivas.
